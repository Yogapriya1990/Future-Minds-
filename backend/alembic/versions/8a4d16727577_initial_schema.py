...
def upgrade() -> None:
    ...
    sa.Column('model', sa.Enum('gpt_4o', 'claude_sonnet', name='toolmodel'), nullable=False),
    ...
    sa.Column('model', sa.Enum('gpt_4o', 'gpt_4o_mini', 'claude_sonnet', 'claude_haiku', name='aimodel'), nullable=False),
